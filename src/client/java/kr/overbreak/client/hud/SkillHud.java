 ...
 * 오버워치 방식 스킬 HUD.
 *
 *   오른쪽 아래: [무기 한 칸] [우클릭] [웅크리기] [E] — 기울어진 칸에 흰색 단색 아이콘, 칸 아래 키 표시
 *     준비     : 밝은 아이콘
...
public final class SkillHud {
	...
	public static void register() {
		...
		HudElementRegistry.attachElementBefore(VanillaHudElements.CROSSHAIR, Overbreak.id("trail_pursuit"), kr.overbreak.client.fx.HomingView::hud);
