...
final class PatchNotes {
	...
	static final List<Version> VERSIONS = List.of(new Version("0.2f", "", "궤적 추격", List.of(
			...
			new Section("궤적의 깃털", 0xFF7FD4FF, List.of(
					...
					nerf("사선 앵커를 점프로 끊으면 갈고리 자리보다 1.5칸 위까지만 솟구칩니다 — 수직으로 걸고 끊으면 너무 높이 올라갔습니다 (가던 관성은 그대로)"))))),
