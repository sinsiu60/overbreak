...
final class PatchNotes {
	...
	static final List<Version> VERSIONS = List.of(new Version("0.2d", "", "죽음의 꽃, 그리고 손맛", List.of(
			...
			new Section("궤적의 깃털 — 곡예 난사", 0xFF7FD4FF, List.of(
					tweak("웅크리기 + 우클릭에서 웅크리기 하나로 바뀌었습니다"),
					buff("이제 조준을 보지 않습니다 — 반경 8칸 안의 모든 적이 맞습니다 (벽 뒤도)"),
					tweak("쓰는 동안 발밑에 반경 8칸 원이 깔려 사거리가 눈에 보입니다"),
					tweak("리퍼의 죽음의 꽃처럼 두 팔을 활짝 벌리고 한 바퀴 돌며 사방으로 퍼붓습니다"),
					tweak("도는 동안 사이버펑크 산데비스탄 같은 잔상이 남습니다"),
					tweak("도는 동안 시점이 3인칭으로 바뀌었다가 끝나면 쓰던 시점으로 돌아옵니다"))),
			new Section("궤적의 깃털 — 체공 훈풍", 0xFF7FD4FF, List.of(
					tweak("활공이 「공중에서 웅크리기」 에서 「공중에서 점프 키 누르고 있기」 로 옮겼습니다 — 웅크리기가 스킬 키가 되었기 때문입니다"),
