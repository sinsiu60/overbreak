...
public final class IronAnim {
	...
	private static final float[][] SWING_L = {
			...
			{18.0F, 0.80F, -0.60F, -0.95F, -6F, 10F, 8F, 1.0F}};
	/** 3타 — 칼을 곧게 세워 높이 치켜듦 (칼날이 화면 위 밖으로) → 화면 가운데를 수직으로 내려침 → 칼끝이 땅에 박힌 듯 멈춤. */
	private static final float[][] OVERHEAD = {
			REST,
			{7.0F, 0.26F, -0.26F, -0.95F, 4F, 0F, 0F, 1.0F},
			{9.0F, 0.25F, -0.22F, -0.93F, 8F, 0F, 0F, 1.0F},
			{10.0F, 0.18F, -0.40F, -1.00F, -45F, 0F, 0F, 1.0F},
			{11.0F, 0.14F, -0.60F, -0.95F, -95F, 0F, 0F, 1.0F},
			{16.0F, 0.14F, -0.62F, -0.93F, -97F, 0F, 0F, 1.0F},
	...
	/** 대지 가르기 — 오른쪽 뒤 아래로 내려 칼끝이 화면 오른쪽 아래 밖으로 → 화면 아래를 오른쪽 뒤 → 정면으로 긁어 올림 → 튕겨 올림. */
	private static final float[][] REND = {
			REST,
			{6.0F, 0.62F, -0.82F, -0.80F, -30F, -30F, -110F, 1.0F},
			{8.0F, 0.40F, -0.74F, -0.98F, -110F, -10F, -20F, 1.0F},
			{10.0F, 0.28F, -0.58F, -1.00F, -50F, 0F, 5F, 1.0F},
			{16.0F, 0.80F, -0.60F, -0.95F, -6F, 10F, 8F, 1.0F}};
