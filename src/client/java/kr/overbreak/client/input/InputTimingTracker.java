...
/**
 * 스킬 키 서브틱 — 화면 프레임마다 5개 키(공격 · 사용 · 웅크리기 · 손 바꾸기 · 버리기)의 눌림을 보고,
...
public final class InputTimingTracker {
	...
	public static void frame(Minecraft mc) {
		...
		KeyMapping[] keys = {mc.options.keyAttack, mc.options.keyUse, mc.options.keyShift, mc.options.keySwapOffhand, mc.options.keyDrop};
